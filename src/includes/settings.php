				...
				'tabs' => [
					...
					[
						...
						'sections' => [
							...
							[
								'slug' => 'four',
								'heading' => 'Content Filters (Keyword Blacklist)',
								'desc' => '<p>Some spammers are going to get through reCaptcha. You can specify a list of unallowed keywords here, so that if a message contains one or more, it will be invisibly dropped. No email will be sent, but the user won\'t be told.</p>',
								'fields' => [
									[
